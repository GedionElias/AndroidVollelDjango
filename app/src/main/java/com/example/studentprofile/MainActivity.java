...
//        }
    ...
    public void SignIN(View B) throws MalformedURLException, URISyntaxException, InterruptedException {
        Button b = (Button)B;
        ...
        if(!username.isEmpty() && !password.isEmpty()) //username and password validations
        {
            ...
            {
                /*Log.i("JSON:::", "SighIne: "+P.getResponseBody());
                ...
                /*Log.i("JSON:::", "SighIne: "+P.getResponseBody());
                Intent articlelist = new Intent(this,ArticleList.class);
                articlelist.putExtra("displayLogin",P.getResponseBody());
                store.loadAllCookies();
                this.finish();
                startActivity(articlelist);*/

                Log.i("JSON:::", "SighIne: "+P.getResponseBody());
                Intent articlelistVolly = new Intent(this,ArticleListVolly.class);
                articlelistVolly.putExtra("displayLogin",P.getResponseBody());
                store.loadAllCookies();
                this.finish();
                startActivity(articlelistVolly);
            }
