...
public class BasicCookieStore implements CookieStore {
    private static final String TAG = BasicCookieStore.class.getSimpleName();
    ...
    public BasicCookieStore(Context context)
    {
    ...
    private void saveToPersistence(URI uri, HttpCookie cookie) {
        ...
        editor.putString(uri.toString() + SP_KEY_DELIMITER + cookie.getName(),
                new com.example.studentprofile.SerializableHttpCookie().encode(cookie));
